 ...
 * @author Windows
 */
public class FRMGerenciamentoAmigos extends javax.swing.JFrame {

    /**
     * Creates new form FRMGerenciamentoAmigos
     */
    public FRMGerenciamentoAmigos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRMGerenciamentoAmigos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRMGerenciamentoAmigos().setVisible(true);
            }
        });
    }
